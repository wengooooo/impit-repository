...
func main() {
	...
	fmt.Println("Sending request to https://httpbin.org/get...")
	...
	// --- 演示 HTML 请求 ---
	fmt.Println("\nSending request to https://httpbin.org/html...")
	reqInitHTML := impit.RequestInit{
		Method: "GET",
		URL:    "/html",
	}
	respDataHTML := impit.HandleRequest(client, reqInitHTML)
	handleResponse(respDataHTML)
}
